...
include '../BD/conexion.php';
 	...
 	function GetForos($id_cursox,$id_userx,$id_foro){               
		$con = new Conexion();
		$ca=$con->initConnection();
    $result = mysqli_query($ca, "call SP_SUBSANACION_FOROS
 		('$id_cursox','$id_userx','$id_foro');") or die("Query fail: " . mysqli_error());
		$data = [];
     ...
     function GetDistinc($id_cursox){               
    $con = new Conexion();
    $ca=$con->initConnection();
    $result = mysqli_query($ca, "call SP_SUBSANACION_FOROS_DISTINC
    ('$id_cursox');") or die("Query fail: " . mysqli_error());
    $data = [];
      if (mysqli_num_rows($result)>0){
        while ($row = mysqli_fetch_array($result, MYSQLI_NUM)){
             array_push($data,array(
    ...
    function UpdateEstudiantes($id_curso_sub,$camp,$nrc,$periodo,$bloque, $manual,$id_user_sv){               
    $con = new Conexion();
    $ca=$con->initConnection();
        $result = mysqli_query($ca, "call SP_SUBSANACION_INSERTAR_ESTUDIANTES('$id_curso_sub,$camp,$nrc,$periodo,$bloque, $manual,$id_user_sv);") or die("Query fail: " . mysqli_error());
     ...
     function GetList($id_userx,$id_cursox){               
    $con = new Conexion();
    $ca=$con->initConnection();
    $result = mysqli_query($ca, "call SP_SUBSANACION_LISTAR
    ('$id_userx','$id_cursox');") or die("Query fail: " . mysqli_error());
    $data = [];
      if (mysqli_num_rows($result)>0){
        while ($row = mysqli_fetch_array($result, MYSQLI_NUM)){
                               array_push($data,array(
    ...
    $data = [];
     ...
     function GetSubsanacions($id_cursox){               
    $con = new Conexion();
    $ca=$con->initConnection();
    $result = mysqli_query($ca, "call SP_SUBSANACION_LISTAR_SUBSANACION
    ('$id_cursox');") or die("Query fail: " . mysqli_error());
    $data = [];
      if (mysqli_num_rows($result)>0){
        while ($row = mysqli_fetch_array($result, MYSQLI_NUM)){
    ...
    function GetQuiz($id_userx,$id_cursox){               
    $con = new Conexion();
    $ca=$con->initConnection();
    ...
    function GetPerformings($id_cursox){               
    $con = new Conexion();
    $ca=$con->initConnection();
    ...
    $data = [];
      ...
      function GetPerformingsSQL($id_cursox){               
    $con = new Conexion();
    $ca=$con->initConnection();
    ...
    $con = new Conexion();
    $ca=$con->initConnection();
        $result = mysqli_query($ca, "call SP_SUBSANACION_UPDATE_ESTUDIANTES('$camp','$nrc','$periodo','$bloque','$id_curso_sub','$id_user_sv');") or die("Query fail: " . mysqli_error());
        ...
        function GetExiste($id_curso_sub,$id_user_sv){               
    $con = new Conexion();
    $ca=$con->initConnection();
    $result = mysqli_query($ca, "call SP_SUBSANACION_VALIDAR_EXISTE
    ('$id_curso_sub','$id_user_sv');") or die("Query fail: " . mysqli_error());
    $data = [];
      if (mysqli_num_rows($result)>0){
        while ($row = mysqli_fetch_array($result, MYSQLI_NUM)){
                               array_push($data,array(
     ...
     function GetPonderacion($id_cursox){               
    $con = new Conexion();
    $ca=$con->initConnection();
